...
<?php 
  ...
  if(isset($_POST['ngaybatdaunghi'])) $ngaybatdaunghi=$_POST['ngaybatdaunghi'];else $ngaybatdaunghi="";
  if(isset($_POST['songaynghi'])) $songaynghi=$_POST['songaynghi'];else $songaynghi="";
  if(isset($_POST['lydo'])) $lydo=$_POST['lydo'];else $lydo="";
  if(isset($_POST['send']))
  {
    $sql = "select nhanvien.HoTen,nhanvien.MaNV from nhanvien
      ...
      $sqll = "SELECT * FROM lichnghi ORDER BY Id DESC LIMIT 1";
      ...
      $sqli = "INSERT INTO lichnghi(Id,MaNV,TenNV,NgayNghi,SoNgayNghi,LyDo,ChoPhepNghi)
                VALUES('$maId','$manv','$hoten','$ngaybatdaunghi','$songaynghi','$lydo','')";
      if (mysqli_query($conn, $sqli))
            {
              echo "<script>alert('Thêm lịch nghỉ thành công')</script>";           
            }
            else
              echo "<script>alert('Thêm lịch nghỉ thất bại')</script>";
  }
?>
  <!-- /.control-sidebar -->
                        ...
                        <div class="col-lg-12 col-md-12  col-sx-12">
                          <form action="#" method="post">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                  <input type="date" class="form-control" name="ngaybatdaunghi" required="required">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Số ngày nghỉ</label>
                                <div class="col-sm-4">
                                  <input type="number" class="form-control" name="songaynghi" required="required">
                                </div>
                              </div>                       
                              <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                   <div class="form-group">
                                        <textarea class="form-control rounded-0" name="lydo" rows="3" required="required"></textarea>
                                   </div>
                                </div>
                              </div>
                              <div class="form-group row">
