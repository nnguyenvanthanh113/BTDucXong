...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">          
            <div class="content-header">
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-12">
                    <h1 class="m-0 text-dark" style="color:red !important;">TRANG QUẢN LÝ</h1>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sx-4">
                            <button class="btn" onclick="hosonhanvien()"><i class="fa fa-folder"></i> HỒ SƠ NHÂN VIÊN</button>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sx-4">
                            <button class="btn" onclick="hosotuyendung()"><i class="fa fa-folder"></i> HỒ SƠ TUYỂN DỤNG</button>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sx-4">
                                Thông báo !
                        </div>
    ...
    <script>
        function hosonhanvien(){
            location.assign("hosonhanvien.php");
        }
        function hosotuyendung(){
            location.assign("hosotuyendung.php");
        }
    </script>
