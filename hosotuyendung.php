        ...
        <div class="content-wrapper">          
            <div class="content-header">
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-12">
                    <h1 class="m-0 text-dark" style="color:red !important;">Hồ Sơ Tuyển Dụng</h1>
                  </div>
                </div>
              </div>
            </div>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <form action="hosotuyendung.php" method="GET">
                            <div style="padding-left: 50px;">
						      <input type="text" placeholder="Search.." name="tentuyendung">
						      <button type="submit"><i class="fa fa-search"></i></button>
					        </div>
					        <br><br>
					        <div id='table'>
					        <?php 
					        	if(isset($_GET['tentuyendung']))
					        	{
					        		$tentuyendung = $_GET['tentuyendung'];
					        		//var_dump($tennhanvien);
					        		$sqli = "SELECT HoTen,CV,GhiChu FROM tuyendung
					        			WHERE HoTen LIKE '%".$tentuyendung."%'";
					        	...
					        	else
					        	{
					        		$sqli = "SELECT HoTen,CV,GhiChu FROM tuyendung";
					        	     ...
					        	     $result = mysqli_query($conn,$sqli) or die('could not seclect');
                                      if(mysqli_num_rows($result)==0)
                                        echo "chưa có nhân viên tuyển dụng";
                                      else
                                      {
                                      	echo "<table border='1'>";
